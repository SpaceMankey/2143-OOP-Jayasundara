...
class Player(object):
    ...
    """
    @Method: RandomRoll
    @Description:A player rolls a random amount of times till he rolls a 0. The TargetScore is checked after every roll.
    @Params: None 
    ...
    """
    @Method: Aggressive
    @Description: Player rolls about 3 more rolls than average
    @Params: None
    @Returns: (Score, NumRolls)
    """
    def Aggressive(self):
    ...
    """
    @Method: Cautious
    @Description: Player rolls about 3 rolls less than average
    @Params: None
    @Returns: (Score, NumRolls)
    """    		
    def Cautious(self):
        Score = 0
        Roll = 0
        for i in range(randint(self.Strategies['Cautious']),6):
        		NumRolls = NumRolls + 1
        		roll = self.pig.Roll()
        		if roll == 0:
        			score = 0
    ...
    @Description: Player rolls until he/she reaches the TargetScore or until he/she rolls a zero
    @Params: None
    @Returns: (Score, NumRolls)
    """
